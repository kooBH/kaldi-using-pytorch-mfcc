...
#chime4_data=`pwd`/../..
chime4_data=/home/nas/DB/CHiME4
chime3_data=/home/nas/DB/CHiME3
...
if [ $stage -le 3 ]; then
  local/run_gmm_mfcc.sh --add-enhanced-data $add_enhanced_data \
